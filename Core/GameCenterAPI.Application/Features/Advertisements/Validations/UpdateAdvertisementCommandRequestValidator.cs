...
{
    public class UpdateAdvertisementCommandRequestValidator : AbstractValidator<UpdateAdvertisementCommandRequest>
    {
        public UpdateAdvertisementCommandRequestValidator()
        {
            RuleFor(x => x.Title)
